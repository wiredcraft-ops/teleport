...
teleport:
  storage:
    ...
    # This value can be configured as shown below and can be set to any integer number
    # representing seconds. If set to 0, TTL is disabled.
    audit_retention_period: 365 * 24 * 60 * 60
```
